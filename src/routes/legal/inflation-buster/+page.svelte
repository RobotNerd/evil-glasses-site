...
<div class="w-1/2">
	<h2 class="h2 mb-2">Privacy Policy</h2>
	<p class="mb-4">Last updated: July 20, 2023</p>
	<p class="mb-4">
	...
	<h2 class="h2 mb-2">Interpretation and Definitions</h2>
	<h3 class="h3 mb-2">Interpretation</h3>
	<p class="mb-4">
		The words of which the initial letter is capitalized have meanings defined under the following
		conditions. The following definitions shall have the same meaning regardless of whether they
		appear in singular or in plural.
	</p>
	<h3 class="h3 mb-2">Definitions</h3>
	...
	<ul class="mb-4 ml-10">
		...
		<li class="list-disc">
			<p class="mb-4">
				<strong>Application</strong> refers to Inflation Buster, the software program provided by the
				Company.
			</p>
		</li>
		<li class="list-disc">
		...
		<li class="list-disc">
			<p class="mb-4"><strong>Service</strong> refers to the Application.</p>
		</li>
		<li class="list-disc">
			<p class="mb-4">
	...
	<h2 class="h2 mb-2">Collecting and Using Your Personal Data</h2>
	<h3 class="h3 mb-2">Types of Data Collected</h3>
	<h4 class="h4 mb-2">Personal Data</h4>
	<p class="mb-4">
	...
	<ul class="mb-4 ml-10">
		<li class="list-disc">Usage Data</li>
	</ul>
	<h4 class="h4 mb-2">Usage Data</h4>
	...
	<h4 class="h4 mb-2">Information Collected while Using the Application</h4>
	<p class="mb-4">
		While using Our Application, in order to provide features of Our Application, We may collect,
		with Your prior permission:
	</p>
	<ul class="mb-4 ml-10">
		<li class="list-disc">Information regarding your location</li>
	</ul>
	<p class="mb-4">
	...
	<h3 class="h3 mb-2">Use of Your Personal Data</h3>
	...
	<h3 class="h3 mb-2">Retention of Your Personal Data</h3>
	<p class="mb-4">
	...
	<h3 class="h3 mb-2">Transfer of Your Personal Data</h3>
	<p class="mb-4">
	...
	<h3 class="h3 mb-2">Delete Your Personal Data</h3>
	<p class="mb-4">
	...
	<h3 class="h3 mb-2">Disclosure of Your Personal Data</h3>
	<h4 class="h4 mb-2">Business Transactions</h4>
	<p class="mb-4">
		If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be
		transferred. We will provide notice before Your Personal Data is transferred and becomes subject
		to a different Privacy Policy.
	</p>
	<h4 class="h4 mb-2">Law enforcement</h4>
	<p class="mb-4">
		Under certain circumstances, the Company may be required to disclose Your Personal Data if
		required to do so by law or in response to valid requests by public authorities (e.g. a court or
		a government agency).
	</p>
	<h4 class="h4 mb-2">Other legal requirements</h4>
	<p class="mb-4">
	...
	<ul class="mb-4 ml-10">
		...
		<li class="list-disc">Protect and defend the rights or property of the Company</li>
		<li class="list-disc">
			Prevent or investigate possible wrongdoing in connection with the Service
		</li>
		<li class="list-disc">Protect the personal safety of Users of the Service or the public</li>
		<li class="list-disc">Protect against legal liability</li>
	</ul>
	<h3 class="h3 mb-2">Security of Your Personal Data</h3>
	<p class="mb-4">
	...
	<h2 class="h2 mb-2">Children's Privacy</h2>
	<p class="mb-4">
	...
	<h2 class="h2 mb-2">Links to Other Websites</h2>
	<p class="mb-4">
	...
	<h2 class="h2 mb-2">Changes to this Privacy Policy</h2>
	<p class="mb-4">
	...
	<h2 class="h2 mb-2">Contact Us</h2>
	<p class="mb-4">If you have any questions about this Privacy Policy, You can contact us:</p>
	<ul class="mb-4 ml-10">
		<li class="list-disc">
			<p class="mb-4">
				By email: <a class="underline" href="mailto:contact@evilglasses.com"
					>contact@evilglasses.com</a
				>
			</p>
		</li>
		<li class="list-disc">
			<p class="mb-4">
				...
				<a
					href="https://evilglasses.com/"
					rel="external nofollow noopener"
					target="_blank"
					class="underline">https://evilglasses.com</a
				>
			</p>
		</li>
	</ul>
