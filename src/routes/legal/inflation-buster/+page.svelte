<h2 class="h2 mb-8 w-1/2">Privacy Policy for Inflation Buster</h2>

<div class="w-1/2">
	<h2 class="h2">Privacy Policy</h2>
	<p>
		Evil Glasses built the Inflation Buster app as an Ad Supported app. This SERVICE is provided by
		Evil Glasses at no cost and is intended for use as is.
	</p>
	<p>
	...
	<p>
		...
		which are accessible at Inflation Buster unless otherwise defined in this Privacy Policy.
	</p>

	<h2 class="h2">Information Collection and Use</h2>
	<p>
		For a better experience, while using our Service, I may require you to provide us with certain
		personally identifiable information, including but not limited to IP address, User product
		interactions, Diagnostic information, Device and Account identifiers. The information that I
		request will be retained on your device and is not collected by me in any way.
	</p>
	<div>
		<p>The app does use third-party services that may collect information used to identify you.</p>
		<p>Links to the privacy policies of third-party service providers used by the app</p>
		<ul>
			<li>
				<a
			...
			<li>
				<a href="https://godotengine.org/privacy-policy" target="_blank" rel="noopener noreferrer"
					>Godot</a
				>
			</li>
		</ul>
	...
	<h2 class="h2">Links to Other Sites</h2>
	<p>
	...
	<p>This policy is effective as of November 29, 2023.</p>

	<h2 class="h2">Contact Us</h2>
	<p>
		If you have any questions or suggestions about my Privacy Policy, do not hesitate to contact me
		at contact@evilglasses.com.
	</p>
	<p>
