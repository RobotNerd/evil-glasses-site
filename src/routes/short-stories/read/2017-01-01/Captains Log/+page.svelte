<span class="w-2/3 max-w-md">
	<h1 class="h2 mb-1 sm:h1 sm:mb-4">Captain's Log</h1>
	...
	<br />
	<p class="mb-4">
		While observing the planet Apex Nine in the Outer Straus System, a mysterious cloud of organic
		matter, comprised mostly of hydrogen, oxygen, carbon, and nitrogen, appeared near the ship. It
		moved like ocean waves. Quickly the cloud surrounded the ship and seeped inside.
	</p>
	<p class="mb-4">
		I put all decks on high alert. Kalal Trainer, Chief of Bioengineering, confirmed that the cloud
		...
		more tests to see what else may lay in their elemental makeup.
	</p>
	<p class="mb-4">
		I lowered the ship-wide alert to yellow. I trusted Chief Trainer, but I needed the Doctor
		involved as well.
	</p>
	<p class="mb-4">
		The Doctor, Tom Orlando, had already heard everything about the cloud but was more concerned
		...
		recovered and showed no signs of ever being infected by the virus.
	</p>
	<p class="mb-4">
		I liked to think that having my nine crewmembers back to work wasn't a problem, but the Doctor
		...
		ignore his mumblings about “real” priorities.
	</p>
	<p class="mb-4">
		While I was content in waiting for Trainer and Orlando's conclusions, my First Officer, Sam
		...
		due to a phobia of “body snatchers.” After what happened to him on Shalous, I don't blame him.
	</p>
	<p class="mb-4">
		It was at this point that I thought I heard a tinny, small voice on the bridge. It was hard to
		tell what language it was, but I'm sure some of it was English. Something
	</p>
	<br />
	<br />
	<p class="mb-4">
		about final destruction of them. Castle heard a different voice; he described his as being deep
		and slow.
	</p>
	<p class="mb-4">
		The Doctor came on the view screen. Before he could get a word out I asked if he had heard any
	...
	<p class="mb-4">
		Chief Trainer came on the view screen with a priority message. Crewmembers in Bioengineering
		...
		was aggressively Napoleonic.
	</p>
	<p class="mb-4">
		Once Trainer came onto the bridge, the voices started twittering, cheering, and roaring. It was
	...
	<p class="mb-4">
		The First Officer walked to the drive console with heavy feet, his arms swung wildly. Worry was
		...
		OP-93. Last time the system was catalogued there were no life forms present.
	</p>
	<p class="mb-4">
		The Lclalies cheered. Castle gasped and hugged himself as he apologized for disobeying an order.
	...
	<br />
	<p class="mb-4">
		Without warning, the entire bridge crew was beamed down to OP-93. I called back to Definitive,
	...
	<p class="mb-4">
		The ever-present Lclalies told us we were standing in the middle of hostile territory and that
		in order to survive, we must fight. They said the Xxuzula were fierce, frightening, unforgiving
		warriors with no remorse or conscience. The Xxuzula were, in simple terms, killers.
	</p>
	<p class="mb-4">
		Castle was trying to make himself vomit out the Lclalie inside of him. His Lclalie laughed and
		assured him that it was deeper in his body than that. We had no weapons, we had no defense. How
		would we survive against such skilled and terrifying creatures?
	</p>
	<p class="mb-4">
		Off in the distance we noticed circular lights flashing and quickly bouncing toward us. I looked
		...
		the sight. After what happened to him on Cenjal, I don't blame him.
	</p>
	<p class="mb-4">
		The Xxuzula were actually clusters of handball-sized lights. As they approached, they shot
		...
		it in two pieces that dissipated quickly, the light dying.
	</p>
	<p class="mb-4">
		Chief Trainer pulled Castle away from attacking another Xxuzula and then was struck himself by
		...
		puffed away into nothing.
	</p>
	<p class="mb-4">
		I called to the crewmembers who were laying on the ground. They were dazed by the blast but
		other wise uninjured. The Xxuzula stopped firing on us and backed away. The Lclalies yelled for
		us to keep attacking, they moved our arms, our legs toward the Xxuzula.
	</p>
	<br />
	<br />
	<p class="mb-4">
		The Doctor called down and excitedly explained that he found a way to remove the Lclalies from
		...
		as the Doctor removed it.
	</p>
	<p class="mb-4">
		I assured the Xxuzula that humans were not their enemy and that the Lclalies were controlling
		...
		the whole of the Lclalies.
	</p>
	<p class="mb-4">
		The bridge crew and myself beamed back to Definitive. My recommendation moving forward is to set
		an observation satellite around the planet and monitor the Xxuzula. First Officer Castle agrees
		completely on the destruction of the Lclalies. I don't blame him.
	</p>
</span>
