<span class="w-2/3 max-w-md">
	<h1 class="h2 mb-1 sm:h1 sm:mb-4">Memories of the End</h1>
	<h3 class="h4 mb-8 sm:h3">by Marshall Bowles</h3>

	<p class="mb-4">
		You float in the black soup. You have no body, only your eyes, your consciousness, suspended on
		the metaphysical plane. Small dots of glowing light surround you in all directions, millions,
		billions, too many to imagine. You feel the weight of them and it makes you claustrophobic.
	</p>
	<p class="mb-4">
		Your thoughts are hazy, and you struggle to focus. You can't remember who you are or how you
		came to be. There is no past, future, or present. There just is. After an instant and an
		eternity, you <i>move</i>. Your consciousness brushes against the closest points of light—
	</p>
	<br />
	<p class="mb-4">
		<i
			>My wife sits across from me in our booth at the diner. Today is our 50th anniversary, and we
			...
			move. I hear my wife screaming in the last few seconds before I lose consciousness.</i
		>
	</p>
	<br />
	<p class="mb-4">
		<i
			>I'm seven years old. The kids in my neighborhood play baseball in the yard in front of a
			light blue house with white trim. Eric</i
		><i>—my</i><i> best friend since kindergarten</i><i>—hits</i><i>
			a long one. It's easy to do, because the yard is small. I jump as high as I can, but the
			stupid ball flies by just out of reach. I run into the street to get it. I only see the car
			briefly in my peripheral vision before it runs over me.</i
		>
	</p>
	<br />
	<p class="mb-4">
		<i
			>I trudge through knee-deep snow. My hands and feet have been numb for the last hour, and I'm
			barely going anywhere. The camp is less than a mile away, just over the next rise, but I don't
			think I can make it. I'm so tired and</i
		><i>—that</i><i>'s odd</i><i>—I</i><i
			>'m not cold anymore. I stopped shivering at some point. Huh. I'm going to take a break, just
			for a minute. I lay down in the snow to build up my ene</i
		>rgy. I close my eyes and take a deep breath.
	</p>
	<br />
	<p class="mb-4">
		You spiral back into the black soup, your mind reeling from the intensity of the visions. You
	...
	<p class="mb-4">You wait.</p>
	<p class="mb-4">And wait.</p>
	<p class="mb-4">
		You have no way to measure the passage of time. Nothing exists except the lights. You grow weary
		of staring at them. The lack of stimulation is painful.
	</p>
	<p class="mb-4">You drift toward the closest lights.</p>
	<br />
	<p class="mb-4">
		<i
			>I check the clamps on my harness to make sure I'm secured to the tower. I'm hundreds of feet
			...
			lose my grip, and I fall the last ninety feet onto the pavement below.</i
		>
	</p>
	<br />
	<p class="mb-4">
		<i
			>I'm the lookout for my boy Thomas while he does a drug deal. He's one of the bros from my
	...
	<p class="mb-4">
		<i
			>I lay in the hospice bed, all three generations of my family standing around me. Every breath
			...
			says. I smile and the world fades away.</i
		>
	</p>
	<br />
	<p class="mb-4">
		You lose something of yourself with every death, a part of your essence that you don't
		understand but you know is important. This bothers you. Boredom bothers you more.
	</p>
	<p class="mb-4">You move again.</p>
	<br />
	<p class="mb-4">
		<i
			>I run through the jungle, holding my rifle vertically in front of me so it will not get
			...
			known him all my life, and I consider him a friend. He has no such qualms.</i
		>
	</p>
	<br />
	<p class="mb-4">
		<i
			>The mountain road is icy. Driving in the snow terrifies me, so I go slow. Tim is in his
			...
			have I done to my child? The rocks below rush at us.</i
		>
	</p>
	<br />
	<p class="mb-4">
		<i
			>The asshole prison guard straps me into the chair and lowers the dome onto the top of my
	...
	<br />
	<p class="mb-4">
		This is all there is now. Death. Nothing else exists, no meaning, no purpose, no escape. You can
		stop, just for an infinite instant, but you will eventually move again. You have to. There are
		no other choices.
	</p>
	<p class="mb-4">The lights beckon to you. You go to them.</p>
</span>
