<span class="w-2/3 max-w-md">
	<h1 class="h2 mb-1 sm:h1 sm:mb-4">EOW Insurance</h1>
	<h3 class="h4 mb-8 sm:h3">by Mike Kirkendall</h3>
	...
	<p class="mb-4">
		Jackson Morris (otherwise known as Agent# CDK556, and Jax to everyone else) hit send on his
	...
	<p class="mb-4">
		Putting the device aside, he picked up his camera and used the zoom feature to watch the house.
		...
		these fights get nasty, and the challenging male does not back down as easy, and a Troll dies…
	</p>
	<p class="mb-4">
		One of these fights took place as he watched the house and waited for a response. Jackson was
		happy that the Trolls were busy with each other, and not looking around for something to kill <code
			>&#8212;</code
		> responses from the Wave Net could take anywhere from minutes to hours, depending on how the messages
		...
		to send simple photographs.
	</p>
	<p class="mb-4">
		Satisfied that the Trolls were not going anywhere anytime soon, Jackson slowly crawled backwards
		...
		tree, silently awaiting his return.
	</p>
	<p class="mb-4">Jax waited.</p>
	<p class="mb-4">
		He ate some food; a compressed cake of corn, berries, seeds and dried beef. It was not that bad
		for field food, and had all the nutrients that his body needed.
	</p>
	<p class="mb-4">Jax waited.</p>
	<p class="mb-4">He drank some fresh apple juice out of an old sports-drink bottle.</p>
	<p class="mb-4">Jax waited.</p>
	<p class="mb-4">
		He checked on the Trolls; one was beating another over the head with what looked like a human
		leg, as he ate what looked like a human arm.
	</p>
	<p class="mb-4">Jax waited.</p>
	<p class="mb-4">
		He wiped down the outside and lightly lubed the bolt on his carbine, an old Sig Sauer 553. He
		...
		a pair of nines and kept it because it did not weigh a lot.
	</p>
	<p class="mb-4">Jax waited.</p>
	<p class="mb-4">
		The temperature was still nice, about the mid 80's. Summertime in the Free Northwest can't be
		beat Jackson thought to himself as he noticed that the “Message” light on his Wave Net device
		was glowing a dull green.
	</p>
	<p class="mb-4">Jax stretched his arms wide, a slight “uhhhhh” escaped his lips at the apex.</p>
	<p class="mb-4">
		“Time to get the fuck out of here,” he quietly said as he picked up the device and hit
		“receive.”
	</p>
	<p class="mb-4">
		AGENT# CDK556 THIS IS EOW INSURANCE. POLICY NOT SATISFIED. SATISFACTION CONDITIONS ON POLICY ARE
		LISTED AS ABSOLUTE. FULFILL ABSOLUTE SATISFACTION REQUIREMENTS AND REPORT BACK.
	</p>
	<p class="mb-4">
		“What the shit? Absolute?” Jackson pulled out Bill's policy and jumped to the satisfaction
		...
		notes and saw the word “seconds.”
	</p>
	<p class="mb-4">
		“Those shady mother…” Selling insurance in a world where everything is trying to kill you is a
		...
		company every month, and when you die, they get a nice payday.
	</p>
	<p class="mb-4">
		Jax just gave his company proof enough that they will have to pay out, now he needed to get
		proof so that his company would get paid. He instantly knew that there was no arguing or
		complaining, absolute is absolute, and End Of World Insurance wants their money.
	</p>
